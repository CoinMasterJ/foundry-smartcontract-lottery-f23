...
contract FundSubscription is Script {
  ...
  function fundSubscriptionUsingConfig() public {
    ...
    function fundSubscription(address vrfCoordinator, uint64 subId, address link, uint256 deployerKey) public {
        console.log("Funding your Subscription");
        console.log("Using vrfCoordinator");
...
contract AddConsumer is Script {
    function addConsumer(address raffle, address vrfCoordinator, uint64 subId, uint256 deployerKey
    ) public {
